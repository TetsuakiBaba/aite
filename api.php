...
function translations(): array
{
    return [
        'ja' => [
            ...
            'event.min_duration_warning_title' => '時間幅が足りません',
            'event.min_duration_warning_body' => '選択した時間幅が最低必要時間の%d分に満たないため、入力をキャンセルしました。%d分以上の範囲を選択してください。',
            'event.min_duration_warning_close' => '閉じる',
            'event.select_all_available' => '全てOK',
            'event.select_all_available_aria' => '全ての時間帯をOKにする',
            'event.clear_available' => '入力を削除',
            'event.clear_available_aria' => 'この日付の入力をすべて削除する',
            ...
            'js.select_available_range' => '調整可能範囲を選択',
            ...
            'js.prompt_ascii_quotes' => 'JSONのキーと文字列は、必ず半角のダブルクォート " で囲んでください。スマートクォート（“ ”）や全角の引用符は使わないでください。',
            'js.prompt_slots' => '候補日時',
            'js.copied' => 'コピーしました。',
            'js.copied_to_clipboard' => 'クリップボードにコピーしました。',
            'js.copy_url' => 'URLをコピー',
        ...
        'en' => [
            ...
            'event.min_duration_warning_title' => 'Selected range is too short',
            'event.min_duration_warning_body' => 'Your selection was canceled because it is shorter than the required %d minutes. Select a range of at least %d minutes.',
            'event.min_duration_warning_close' => 'Close',
            'event.select_all_available' => 'All OK',
            'event.select_all_available_aria' => 'Mark all times as OK',
            'event.clear_available' => 'Clear input',
            'event.clear_available_aria' => 'Clear all input for this date',
            ...
            'js.select_available_range' => 'Select an adjustable range',
            ...
            'js.prompt_ascii_quotes' => 'Use only straight ASCII double quotes (") around every JSON key and string. Do not use smart quotes (“ ”) or full-width quotation marks.',
            'js.prompt_slots' => 'Candidate times',
            'js.copied' => 'Copied.',
            'js.copied_to_clipboard' => 'Copied to clipboard.',
