...
if ($id !== '') {
    ...
    <?php site_footer(); ?>
    <?php js_i18n(); ?>
    <script>window.AITE_EVENT_HISTORY_ITEM=<?= json_encode(['title' => $event['title'], 'url' => $adminUrl, 'type' => 'admin'], JSON_UNESCAPED_UNICODE | JSON_HEX_TAG | JSON_HEX_AMP | JSON_HEX_APOS | JSON_HEX_QUOT) ?>;</script>
